                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                            <a class="nav-link active" href="{{ route('create.meet-consultation-schedule') }}"><i class="fas fa-user-tie"></i> Buat Jadwal Konsultasi Temu Langsung</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" href="{{ route('create.live-consultation-schedule') }}"><i class="fas fa-laptop-medical"></i> Buat Jadwal Live Konsultasi</a>
                            </li>
                        </ul>
                    </div>
                    <form wire:submit.prevent="save">
                        <div class="card-body">
                            <h2 class="section-title mt-0">Jadwal Konsultasi Temu Langsung</h2>
                            <p class="section-lead">
                                Buat Jadwal Available konsultasi anda disini!
                            </p>
                            <div class="row mt-4">
