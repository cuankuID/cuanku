<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav">
        <li>
            <a href="{{ route('dashboard.list.subscription') }}" class="nav-link nav-link-lg ">Langganan</a>
        </li>
    </ul>
    ...
    <li>
        <a href="{{ route('index.activity') }}" class="nav-link nav-link-lg "><i class="fas fa-shopping-cart"></i></a>
    </li>
