			...
			<div class="col-12 col-sm-12 col-lg-12">
				<div class="card">
					<div class="card-header">
						<div class="btn btn-sm btn-info" data-toggle="modal" data-target="#howToPay"><i class="fas fa-info-circle"></i> Cara Pembayaran</div>
							<div class="card-header-action">
								<a href="{{route('history.subscription.cart')}}" class="btn btn-primary"><i class="fas fa-history"></i> Histori Pesanan</a>
							</div>
					</div>
					<div class="card-body">
						<div class="row">
						<div class="col-12 col-sm-12 col-md-3">
							...
							<li class="nav-item">
								<a class="nav-link active" id="subs-tab4" href="{{route('index.subscription.cart')}}">Paket Langganan</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" id="meet-tab4" href="{{route('index.meet.cart')}}">Konsultasi Langsung</a>
							</li>
							</ul>
						</div>
								...
								<div class="row">
									<div class="col-12 col-md-12">
										...
										<div class="card shadow my-3">
											<div class="card-header">
												<div>
													<h4 class="text-dark d-block">Paket {{ $order->subscription->name }}<br>
												...
												<div class="card-header-action">
													<div class="dropdown">
														...
														<div class="dropdown-menu">
															...
															<form class="d-flex" action="{{route('delete.subscription.order', ['subscriptionOrder' => $order->order_id])}}" method="POST">
																@csrf
																@method('delete')
											...
											<div class="card-body">
												<div class="row">
													...
													<div class="col-8 col-md-8 col-sm-8">
														<p class="mb-0">: Rp {{ $order->subscription->price }}</p>
													</div>
												</div>
												<div class="row">
													<div class="col-4 col-md-4 col-sm-4">
											...
											<div class="card-footer">
												...
												<form action="{{route('proof.subscription.order', ['subscriptionOrder' => $order->order_id])}}" method="POST" enctype="multipart/form-data">
													@csrf
													@method('put')
